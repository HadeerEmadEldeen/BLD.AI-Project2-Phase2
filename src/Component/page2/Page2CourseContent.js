...
function Page2CourseContent(props) {
  ...
  if (props.course.content.length > 5) {
    butt = (
      <button className=" more-content" id="header-more-btn" onClick={showmore}>
          ...
          <h3 className="accordion-header " id="heading1">
            ...
            >
              <span className="lecture-title">
                <i className="fa-solid fa-angle-down collapseicon"></i>
                {it[0]}
              </span>
                ...
                {it[1].map((it2) => {
                  return (
                    <>
                      <li>
                        <span>
                          <i className="fa-solid fa-circle-play collapseicon"></i>
                          <span>{it2}</span>
                        </span>
  ...
  return (
    <section id="coursecontent">
      ...
      <div className="course-info">
        <span>
          {props.course.sectionsCount} section •{props.course.lecturesCount}{" "}
          lectures •{props.course.totalLength} total length
        </span>
      </div>
      <div>
...
export default Page2CourseContent;
